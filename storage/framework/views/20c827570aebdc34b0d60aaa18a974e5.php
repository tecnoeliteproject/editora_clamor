            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <a type="button" class="btn btn-warning" wire:navigate href="<?php echo e(route('contacto')); ?>"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        <p class="text-warning text-uppercase fw-bold mb-3">Nossos Serviços</p>
...
<?php /**PATH C:\00\editoraClamor\resources\views/livewire/show-home.blade.php ENDPATH**/ ?>