...
<head>
    <meta charset="utf-8">
    <title><?php echo e($title ?? 'Editora Clamor'); ?></title>
...
<body>
    ...
    <header class="navigation bg-tertiary">
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3">
            <div class="container">
                <a class="navbar-brand" wire:navigate href="<?php echo e(route('inicio')); ?>">
                    <img loading="prelaod" decoding="async" class="img-fluid" width="160"
                        src="<?php echo e(asset('/front/images/logo.png')); ?>" alt="Wallet">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        <li class="nav-item"> <a class="nav-link" wire:navigate href="<?php echo e(route('inicio')); ?>">Início</a>
                        </li>
                        <li class="nav-item "> <a class="nav-link" wire:navigate href="<?php echo e(route('sobre')); ?>">Sobre Nós</a>
                        </li>
                        <li class="nav-item "> <a class="nav-link" wire:navigate
                                href="<?php echo e(route('servicos')); ?>">Serviços</a></li>
                        <li class="nav-item "> <a class="nav-link" wire:navigate href="<?php echo e(route('time')); ?>">Nosso Time</a>
                        </li>
                        <li class="nav-item "><a class="nav-link " wire:navigate href="<?php echo e(route('faq')); ?>">Perguntas</a>
                        </li>
                    </ul>
                    <a wire:navigate href="<?php echo e(route('contacto')); ?>" class="btn btn-outline-primary">Entrar</a>
                </div>
            </div>
        </nav>
    </header>
...
<?php /**PATH C:\Users\DESKTOP\Documents\Programação\editoraClamor\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>