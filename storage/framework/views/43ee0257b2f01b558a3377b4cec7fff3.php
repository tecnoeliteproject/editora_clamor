        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize"><?php echo e($servico->nome); ?></h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate
                                href="<?php echo e(route('servico', $servico->id)); ?>"><?php echo e($servico->nome); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
</main><?php /**PATH C:\00\editoraClamor\resources\views/livewire/show-servico.blade.php ENDPATH**/ ?>