        ...
        <nav class="navbar navbar-expand-xl navbar-light text-center py-3">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a wire:navigate href="<?php echo e(route('contacto')); ?>" class="btn btn-outline-info">Entrar</a>
                </div>
            </div>
        </nav>
    </header>
...
<?php /**PATH C:\00\editoraClamor\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>