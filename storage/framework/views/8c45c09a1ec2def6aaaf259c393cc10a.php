        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Nossos Serviços</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a wire:navigate href="<?php echo e(route('inicio')); ?>">Início</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate href="<?php echo e(route('servicos')); ?>">Serviços</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        ...
                        <h3 class="mb-3"><?php echo e($servico->nome); ?></h3>
                        <p class="mb-4"><?php echo $servico->descricao; ?></p>
                        <a class="btn btn-sm btn-outline-primary" wire::navigate
                            href="<?php echo e(route('servico', $servico->id)); ?>">Ver
                            Detalhes<i class="las la-arrow-right ms-1"></i></a>
                    </div>
                </div>
...
</main><?php /**PATH C:\Users\DESKTOP\Documents\Programação\editoraClamor\resources\views/livewire/show-servicos.blade.php ENDPATH**/ ?>