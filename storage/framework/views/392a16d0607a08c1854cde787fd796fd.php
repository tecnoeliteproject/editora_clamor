            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <a type="button" class="btn btn-success" wire:navigate href="<?php echo e(route('contacto')); ?>"
                            data-bs-toggle="modal" data-bs-target="#applyLoan">Contacte-nos<span
                                style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="<?php echo e(asset('/front/images/sobre.jpg')); ?>"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        <p class="text-success text-uppercase fw-bold mb-3">Nossos Serviços</p>
                        <h1>Nossos Serviços</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipreiscing elit. Lacus penatibus tincidunt</p>
                    </div>
                </div>

                <!--[if BLOCK]><![endif]--><?php if($servicos -> isNotEmpty()): ?>
                <?php
                $x=1;
                ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $servicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" wire:navigate href="<?php echo e(route('servico', $servico->id)); ?>">
                        <div class="block"> <span class="colored-box text-center h3 mb-4"><?php echo e($x); ?></span>
                            <h3 class="mb-3 service-title"><?php echo e($servico->nome); ?></h3>
                        </div>
                    </a>
                </div>
...
<?php /**PATH C:\Users\DESKTOP\Documents\Programação\editoraClamor\resources\views/livewire/show-home.blade.php ENDPATH**/ ?>