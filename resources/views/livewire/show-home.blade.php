            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <a type="button" class="btn btn-success" wire:navigate href="{{route('contacto')}}"
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="{{asset('/front/images/sobre.jpg')}}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" wire:navigate href="{{route('servico', $servico->id)}}">
                        <div class="block"> <span class="colored-box text-center h3 mb-4">{{$x}}</span>
                            <h3 class="mb-3 service-title">{{$servico->nome}}</h3>
                        </div>
                    </a>
                </div>
