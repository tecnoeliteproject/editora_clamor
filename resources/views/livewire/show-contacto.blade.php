        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Contacte-nos</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a wire:navigate href="{{route('inicio')}}">Início</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{route('contacto')}}">Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <p class="text-primary text-uppercase fw-bold mb-3">Contacte-nos</p>
                            ...
                            <div class="col-lg-6 mt-5 mt-lg-0">
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        <h4 class="h5">Ainda há alguma questão?</h4>
                                        <div class="content">Ligue-nos nós estaremos felizes em poder ajudar
                                            <br> <a href="tel:+XXX111222">+9XX-XX-XX-XX</a>
                                            <br>Segunda - Sexta
                                            <br>08h:00 à 17h:30
                                        </div>
                                    </div>
                                    <div class="block mt-4">
                                        ...
                                        <div class="content">Rua Joaquim Capango.
                                            <br>Cuito
                                            <br>Bié
                                        </div>
                                    </div>
