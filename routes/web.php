...
Route::get('/relatorios/usuarios', [PDFReportController::class, 'generateUserReport'])
    ->name('generate.user.report');

Route::get('/relatorio/servicos', [RelatorioServicoController::class, 'gerarRelatorio'])
